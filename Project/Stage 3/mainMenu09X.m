...
% this contains code that stops some part of the code from functioning
...
while loopAgain == true
    ...
    elseif option == 4 % Determine spontaneity based on free energy formula
        ...
        % taking in user input of desired property
    ...
    elseif option == 6 % Use the Quadratic Formula calculator
        % image to help with inputting data
        quadraticFormula = imread("quadraticFormula.png"); % import image
        imshow(quadraticFormula); % display as an image
